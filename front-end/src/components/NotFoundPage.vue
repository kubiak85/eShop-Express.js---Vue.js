            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="error-text">
                        ...
                        <h4>Oops! Strona nie została znaleziona!</h4>
                        <p>Nie bądź owca kliknij przycisk poniżej i przejdź dalej, żeby cieszyć się łąką</p>
                         <router-link to="/" class="btn btn-primary btn-round">Wracaj na łąkę</router-link>
                    </div>
                </div>
            </div>
        </div>
